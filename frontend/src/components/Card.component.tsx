...
export const Card: FC<CardProps> = ({ element }) => {
    ...
    return (
        <li className={styles.card} key={element.id}>
            <img className={styles.productImages} src={element.profileImage} alt={element.title || 'No title available'}/>
            ...
            <div className={styles.productInfoContainer}>
                ...
                <div className={styles.goToCardContainer}>
                    <button className={styles.goToCardButton} onClick={handleButtonClick}>Go To Product</button>
                </div>
            </div>
        </li>
    )
